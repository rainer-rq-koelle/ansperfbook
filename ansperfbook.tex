...
\hypersetup{
  pdftitle={Operational ANS Performance with R/RStudio},
  pdfauthor={Rainer Koelle},
  pdfborder={0 0 0},
  breaklinks=true}
...
\title{Operational ANS Performance with R/RStudio}
...
The website for this (book) project is: \url{https://rainer-rq-koelle.github.io/ansperfbook/}.
The development website is: \url{https://github.com/rainer-rq-koelle/ansperfbook}.

The \textbf{ansperf} package is available at: \url{https://github.com/rainer-rq-koelle/ansperf}.

If you are interested in contributing to this development, please contact \href{mailto:rainer.koelle@eurocontrol.int}{\nolinkurl{rainer.koelle@eurocontrol.int}}.\\
...
Discussions in - \textbf{and lessons learnt from} - these projects revolved around similar themes. This book would have not been possible without the discussions and generous time of all participants in these projects.
...
{\centering \includegraphics[width=0.8\linewidth]{ansperfbook_files/figure-latex/nice-fig-1} 
